...
class TradingSignal:
    ...
    liquidity_trap_detected: bool = False              # FIX #4: PredictivePriceEngine liquidity trap flag (hard-reject if True)
...
class Position:
    ...
    # Track whether this position's opened_at timestamp has been normalized to UTC
