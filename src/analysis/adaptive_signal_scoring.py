...
# GOVERNANCE OVERRIDE: Lowered from 65% to 50% under Option 2: Aggressive with Safeguards
TEMP_GLOBAL_QUALITY_FLOOR = 50.0
...
class AdaptiveSignalFilterer:
    ...
    def __init__(self, min_score: float = 50, ml_accuracy_target: float = 0.55):
        ...
        # ===== PATCH DISABLED: Market-relaxation and surgical patch are forbidden. =====
        self.current_min_score = self.base_min_score  # Always use base min score (no relaxation)
    ...
    def should_trade_signal(self, signal: Dict[str, Any], 
        ...
        ml_accuracy_required = accuracy_floor
